...
const defaultDbState: DatabaseSchema = {
  ...
  recipe_items: [
    ...
    { dish_id: 'm02', material_id: 'nvl07', quantity: 1.0, unit: 'l' },
  ...
  raw_materials: [
    { id: 'nvl01', name: 'Nấm kim châm', unit: 'kg', stock_current: 8.2, stock_min: 2, stock_max: 20 },
    { id: 'nvl02', name: 'Nấm bào ngư', unit: 'kg', stock_current: 4, stock_min: 1.5, stock_max: 15 },
    { id: 'nvl03', name: 'Nấm đùi gà', unit: 'kg', stock_current: 1.2, stock_min: 1, stock_max: 10 },
    ...
    { id: 'nvl07', name: 'Nước dùng', unit: 'l', stock_current: 110, stock_min: 20, stock_max: 250 },
    { id: 'nvl08', name: 'Gà đen', unit: 'kg', stock_current: 0, stock_min: 2, stock_max: 15 },
    { id: 'nvl09', name: 'Thịt bò Mỹ', unit: 'kg', stock_current: 25, stock_min: 5, stock_max: 50 },
